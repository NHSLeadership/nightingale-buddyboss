...
<div class="nhsuk-grid-full-width">
    <nav style="clear: left;" class="nhsuk-bordered-tabs-container secondary" id="subnav" role="navigation" aria-label="<?php esc_attr_e( 'User administration menu', 'nightingale' ); ?>">

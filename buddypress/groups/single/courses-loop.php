...
<div class="nhsuk-card-group__item bb-course-item-wrap nhsuk-grid-column-one-third">
    <div class="bb-cover-list-item nhsuk-card <?php echo $class; ?>">
		<?php
        ...
        <div class="nhsuk-card__content">
            ...
            <div class="nhsuk-card__description">
                ...
                <div class="bb-card-course-details">
					...
					if ( $lessons_count > 0 ) {
						echo '<div class="course-lesson-count nhsuk-body-s">' . $total_lessons . '</div>';
					} else {
